  ...
  return (
    <div className="bg-white rounded-none shadow-none border-2 border-black overflow-hidden flex flex-col h-full">
      <div className="px-6 py-4 border-b-2 border-black bg-slate-50">
        ...
        <p className="text-xs text-slate-500 mt-0.5">Open any previous generation to review it again.</p>
      </div>
        ...
        {items.map((item) => {
          return (
            <div
              ...
              className="w-full text-left p-4 rounded-none border-2 border-black hover:bg-indigo-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-600 transition-colors"
            >
